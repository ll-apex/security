...
_Geschätzte Zeit für den Abschluss des Workshops_: 110 Minuten
...
In dieser Mini-Übung lernen Sie, wie Sie die **Oracle Database Security Assessment Tool**\-(DBSAT-)Features verwenden.
