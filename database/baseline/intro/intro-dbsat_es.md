...
_Tiempo estimado para completar el taller_: 110 minutos
...
En este mini laboratorio, aprenderá a utilizar las funciones de **Oracle Database Security Assessment Tool** (DBSAT).
