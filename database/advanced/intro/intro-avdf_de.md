...
_Geschätzte Zeit für den Abschluss des Workshops_: 150 Minuten
...
*   SSH-Terminalclient
*   Glassfish HR-App
*   Oracle Golden Gate-Webkonsole
*   Oracle AVDF-Webkonsole
...
In dieser Mini-Übung lernen Sie, wie Sie die **Oracle Audit Vault and Database Firewall**\-(AVDF-)Features verwenden.
...
*   **Mitwirkende** - Angeline Dhanarani, Nazia Zaidi, Rene Fontcha
