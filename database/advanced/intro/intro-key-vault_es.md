...
_Tiempo estimado para completar el taller_: 55 minutos
...
*   Consola web de Oracle Key Vault
...
En este mini laboratorio, aprenderá a utilizar las funciones de **Oracle Key Vault** (OKV).
...
*   **Contribuyentes**: Peter Wahl, Rene Fontcha
